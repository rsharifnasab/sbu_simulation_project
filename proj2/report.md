...
## قسمت ب)
## تابع simulate_survival_by_search
در این تابع همانند قسمت قبل عمل می‌کنیم با این تفاوت که سعی می‌کنیم تا با تغییر دادن پارامتر‌های توزیع‌های نمایی و پارتو، متوسط زمان جستو را تغییر دهیم و سپس متوسط زمان بقا را بدست بیاوریم.

![simulate_survival_by_search](report.assets/simulate_survival_by_search.png)

## قسمت ج)
## تابع simulate_isolation_by_search
در این تابع نیز همانند قسمت قبل نیز عمل می‌کنیم با این تفاوت که این سری به جای محاسبه متوسط زمان بقا، متوسط زمان ایزوله‌شدن را محاسبه می‌کنیم.

![simulate_isolation_by_search](report.assets/simulate_isolation_by_search.png)
