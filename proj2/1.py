...
for i, n in zip(range(10), np.geomspace(2, 10, 10, dtype=int)):
    probability_mean_list, equation_3s = calculate_irreducablity_probability_mean(n, p_list, EPOCHS, graph_type)
    ax[i//5, i%5].plot(p_list, probability_mean_list, 'b-', label ='Simulation')
    ax[i//5, i%5].plot(p_list, probability_mean_list, 'r--', label ='Equation 3')
